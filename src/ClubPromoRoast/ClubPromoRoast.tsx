            ...
            <div className="relative pb-16 pt-48 sm:pb-24">
              <div className="w-full md:w-1/2 md:pr-8 flex flex-col space-y-6 items-center justify-center">
                ...
                <p className="text-center text-base text-neutral-100 max-w-sm">
                  ...
                  save between 9/8 and 9/12!
                </p>
                <ClubPromoRoastInner
                  promotion_end_date={promotion_end_date}
                  promotion_start_date={promotion_start_date}
                  title="Long Run Club Bonus"
                  description="Starting Sunday, September 8th, all Long Run Club sign ups get our Brown butter Pumpkin Roast free with their first shipment."
                />
              </div>
